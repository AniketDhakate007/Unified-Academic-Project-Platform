            ...
            <main className="relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <motion.h1
                            variants={fadeUpSlow}
                            className="text-7xl md:text-8xl lg:text-[12rem] font-black leading-[0.8] mb-12 tracking-tighter text-gray-900"
                        >
                            FUTURE
                        </motion.h1>
                        ...
                        <motion.h1
                            variants={fadeUpSlow}
                            className="text-7xl md:text-8xl lg:text-[12rem] font-black leading-[0.8] mb-16 tracking-tighter text-gray-900"
                        >
                            MANAGEMENT
                        </motion.h1>
